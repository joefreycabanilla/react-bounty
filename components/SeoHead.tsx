...
const defaultMeta = {
  title: "bounty.media",
  siteName: "bounty.media",
  description: "bounty.media Providing a new way to pay",
  // change base url of your web (without '/' at the end)
  url: "https://react-bounty.vercel.app",
  type: "website",
  robots: "follow, index",
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status
  image: "https://react-bounty.vercel.app/assets/card-image.png",
  author: "Joef",
};
